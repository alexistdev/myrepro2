...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void buatTablePertanyaan(){
        ...
        Pertanyaan q9 = new Pertanyaan("Bacalah pernyataan berikut ini !<br><br><ul><li>1.Beberapa organ wanita akan mengalami perubahan pasca melahirkan, seperti rahim yang bengkak dan kendur karena menampung bayi selama 9 bulan. Selain itu serviks, vagina dan vulva juga akan mengalami pembengkakan karena dilalui oleh bayi ketika bayi dilahirkan.</li><li>2.Daun sirih merupakan tanaman yang dapat digunakan untuk <i>vaginal steaming</i>. Berdasarkan penelitian daun sirih mengandung minyak atsiri dan zat anti mikroba yang berfungsi untuk mengerutkan luka dan mempercepat menyembuhan luka.</li></ul><br>Simpulan yang tepat untuk kedua wacana tersebut adalah….",""," A.<i>Vaginal steaming</i> merupakan cara yang tepat untuk mengobati luka pada organ intim wanita pasca melahirkan"," B.Daun siri mampu mengobati luka pada rahim"," C.Daun sirih yang diguaakan untuk <i>vaginal steaming</i> dapat memilihkan kondisi organ wanita karena mengandung minyak atsiri dan zat antimikroba"," D.Minyak atsiri dan zat antimikroba daun sirih dapat mengencangkan vagina"," E.Daun sirih digunakan untuk <i>vaginal steaming</i> karena mengandung antimikroba",9,2,3);
        ...
        Pertanyaan q28 = new Pertanyaan("Menstruasi yang dialami wanita setiap bulannya kadang disertai dengan rasa nyeri di bagian perut. Rasa nyeri yang dirasakan pada saat menstruasi sebenarnya dikarenakan….",""," A.Kelainan yang terjadi pada organ reproduksi bagian rahim"," B.Dampak dari konsumsi makanan pedas pada saat menstruasi"," C.Pecahnya pembuluh darah yang terbentuk pada saat masa subur wanita"," D.Kontraksi antara pembuluh darah pada endometrium rahim"," E.Meluruhnya endometrium pada rahim",28,2,5);
        masukkanPertanyaan(q28);
        Pertanyaan q29 = new Pertanyaan("Pak Seto pergi ke dokter karena mengalami keluhan pada alat kelamin yang dialaminya. Keluhan suami tersebut ialah tedapat nanah pada saluran kemih, sering kencing dan terasa panas ketika kencing serta sakit pada beberapa sendi.<br><br>Gelaja-gejala yang dialami oleh pak Seto karena….",""," A.Mengidap penyakit gonorhe"," B.Mengidap penyakit AIDS"," C.Mengidap penyakit sifilis"," D.Mengidap penyakit herpes genitalis"," E.Mengidap penyakit impotensi",29,2,1);
        masukkanPertanyaan(q29);
        Pertanyaan q30 = new Pertanyaan("Masih banyak sebagian orang yang menganggap bahwa sistem reproduksi adalah hal yang tabu untuk dibahas dan tak pantas untuk dibicarakan, padahal pengetahuan mengenai kesehatan reproduksi sangat diperlukan. Bagaimana pendapatmu tentang hal tersebut ?",""," A.Pengetahuan seks menumbuhkan hasrat remaja untuk mencoba melakukan hubungan seks"," B.Pengetahuan seks harus dimulai sedini mungkin untuk mengontrol kondisi psikologis"," C.Pendidikan seks hanya boleh diajarkan kepada mahasiswa saja"," D.Pengetahuan remaja tentang seks mendorong siswa untuk melakukan free seks"," E.Pendidkan seks akan menambah daftar prilaku penyimpangan seksual",30,2,2);
